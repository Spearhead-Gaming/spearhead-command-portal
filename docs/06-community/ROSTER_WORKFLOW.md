...
The roster workflow defines how Spearhead Gaming tracks members, units, positions, statuses, optional ranks, transfers, and personnel history.
...
- Discord ID
- Steam ID / Arma ID
- Rank, optional for current Spearhead usage
- Current unit
- Current position
- Status
- Join date
