...
## Spearhead Qualification Readiness Doctrine

- Qualification readiness is unit-scoped.
- Required qualifications are configured by unit and, where needed, by position.
- Some units may have no required qualifications.
- Required qualifications may include a completion timeline for remaining in the unit.
- Member readiness should evaluate requirements from the member's assigned unit.
